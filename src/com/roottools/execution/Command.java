...
public abstract class Command {
	 ...
	 */
	public Command(int id, boolean javaCommand, Context context,
			String... command) {
		this(id, command);
	 ...
	 *            needed to execute java command.
	 */
	public Command(int id, boolean handlerEnabled, boolean javaCommand,
	 ...
	 *            needed to execute java command.
	 */
	public Command(int id, int timeout, boolean javaCommand, Context context,
			String... command) {
