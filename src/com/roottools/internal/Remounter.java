...
public class Remounter {
	...
	public boolean remount(String file, String mountType) {
		...
		if (mountPoint != null) {
			...
			RootTools.log(Constants.TAG, "Remounting "
			...
			if (!isMountMode) {
				...
				try {
					CommandCapture command = new CommandCapture(0, true,
			...
			if (mountPoint != null) {
				RootTools.log(Constants.TAG, mountPoint.getFlags() + " AND "
						+ mountType.toLowerCase());
				...
				RootTools.log("mount is null, file was: " + file
						+ " mountType was: " + mountType);
			}
		} else {
			RootTools.log("mount is null, file was: " + file
					+ " mountType was: " + mountType);
