...
public class PerAppModeActivity extends Activity implements Constants {
    ...
    private class Apps extends PreferenceFragment implements Constants {
        ...
        private CustomPreference[] mApps;
        ...
        public void onCreate(Bundle savedInstanceState) {
            ...
            new Thread() {
                public void run() {
                    ...
                    mApps = new CustomPreference[apps.size()];
                    String pack = "";
                    for (int i = 0; i < apps.size(); i++) {
                        ...
                        mApps[i] = new CustomPreference(getActivity(), apps
                                .get(i).loadLabel(packageManager).toString(),
                                mUtils.getString(apps.get(i).packageName, "",
                                        getActivity()));
        ...
        private void refresh() {
            ...
            if (!content.get(0).isEmpty()) {
                ...
                for (int i = 0; i < content.size(); i++) {
                    mProfiles[i] = new CustomPreference(getActivity(),
                            content.get(i), null);

                    root.addPreference(mProfiles[i]);
                }
            } else root.addPreference(new CustomPreference(getActivity(), null,
                    getString(R.string.no_profiles)));
        }
